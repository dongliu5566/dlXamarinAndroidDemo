...
public class ActivityLifecycleCallbackHandler
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Caliburn.Micro.ActivityLifecycleCallbackHandler, Caliburn.Micro.Platform", ActivityLifecycleCallbackHandler.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ActivityLifecycleCallbackHandler.class)
			mono.android.TypeManager.Activate ("Caliburn.Micro.ActivityLifecycleCallbackHandler, Caliburn.Micro.Platform", "", this, new java.lang.Object[] {  });
	}

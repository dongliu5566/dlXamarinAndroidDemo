...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("junior.BbsActivity, junior", BbsActivity.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == BbsActivity.class)
			mono.android.TypeManager.Activate ("junior.BbsActivity, junior", "", this, new java.lang.Object[] {  });
	}
